...
<div class="btn-toolbar clip-buttons pull-right">
    <a class="btn btn-primary btn-mini" href="<?php echo $this->createUrl('file/download',  array('id'=>$file->fileId_pk)); ?>">
    ...
    -->
    <a class="btn btn-mini btn-danger file-delete" href="<?php echo $this->createUrl('file/trash', array('id'=>$file->fileId_pk)); ?>">
